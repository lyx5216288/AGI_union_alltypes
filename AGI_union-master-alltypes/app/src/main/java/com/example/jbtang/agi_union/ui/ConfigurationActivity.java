...
public class ConfigurationActivity extends AppCompatActivity {
    ...
    private TextView mystmsi;
    private MonitorHelper monitorHelper;

    private static final int DEFAULT_TRIGGER_INTERVAL_SMS_MIN = 15;
...
//        stopService(startIntent);
        monitorHelper.unbindservice(ConfigurationActivity.this);
        super.onDestroy();
        cmgr.closeDB();
        dmgr.closeDB();
    }
...
//        final RadioGroup types = (RadioGroup) findViewById(R.id.radiogroup_add);
        final RadioButton fdd = (RadioButton) view.findViewById(R.id.device_configure_hint_board_type_fdd);
        final RadioButton all = (RadioButton) view.findViewById(R.id.device_configure_hint_board_type_all);
    ...
    private void initDefaultValue() {
        ...
        mystmsi = (TextView) findViewById(R.id.local_info_my_stmsi);
        ...
        monitorHelper.bindService(ConfigurationActivity.this);
        ...
        if (dao != null) {
            ...
            switch (dao.silentSMSType) {
                case TYPE_ONE:
                    silentSMSType.check(R.id.system_configure_trigger_sms_silent_type_one);
                    break;
                case TYPE_TWO:
                    silentSMSType.check(R.id.system_configure_trigger_sms_silent_type_two);
                    break;
                case TYPE_THREE:
                    silentSMSType.check(R.id.system_configure_trigger_sms_silent_type_three);
                    break;
                case TYPE_FOUR:
                    silentSMSType.check(R.id.system_configure_trigger_sms_silent_type_four);
                    break;
            }
        }
    ...
    private void saveToCache() {
        ...
        switch (silentSMSType.getCheckedRadioButtonId()) {
            case R.id.system_configure_trigger_sms_silent_type_one:
                Global.Configuration.silentSMSType = Status.SilentSMSType.TYPE_ONE;
                break;
            case R.id.system_configure_trigger_sms_silent_type_two:
                Global.Configuration.silentSMSType = Status.SilentSMSType.TYPE_TWO;
                break;
            case R.id.system_configure_trigger_sms_silent_type_three:
                Global.Configuration.silentSMSType = Status.SilentSMSType.TYPE_THREE;
                break;
            case R.id.system_configure_trigger_sms_silent_type_four:
                Global.Configuration.silentSMSType = Status.SilentSMSType.TYPE_FOUR;
                break;
        }
