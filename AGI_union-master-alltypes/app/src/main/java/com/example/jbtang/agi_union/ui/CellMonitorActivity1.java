...
public class CellMonitorActivity1 extends AppCompatActivity {
...
//        saveToNext();
        ...
        monitorHelper.unbindservice(CellMonitorActivity1.this);
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (result == TextToSpeech.LANG_NOT_SUPPORTED
                        ...
                        Toast.makeText(CellMonitorActivity1.this, "数据丢失或不支持", Toast.LENGTH_LONG).show();
                    } else {
...
//        System.out.println(list);
    ...
    private void startService() {
        ...
        monitorHelper.bindService(CellMonitorActivity1.this);
                ...
                try {
                    if (info.tai == Short.parseShort(alarmTAC.getText().toString()) && info.ecgi == Integer.parseInt(alarmECGI.getText().toString())) {
                        ...
                        if(new Date().getTime() - alarmTime.getTime() > 5000) {
                            alarmTime = new Date();
                            Toast.makeText(CellMonitorActivity1.this, "发现目标小区！", Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
