...
public class GenProtocolTraceMsg {
    ...
    private static MsgUSIM_INFO_STRU genMsgUSIM_INFO_STRU() {
        ...
        if(Global.Configuration.targetPhoneImsi.length()==15){
//            Log.e("TRace","11111111");
            if (Global.Configuration.targetPhoneImsi.equals("000000000000000")){
                ret.setMau16SimAC(65535);
            }else {
                ret.setMau16SimAC((int)(Long.parseLong(Global.Configuration.targetPhoneImsi)%1024));
            }
    ...
    private static MsgPROTOCOL_TRACE_CELL_INFO_STRU genPROTOCOL_TRACE_CELL_INFO_STRU() {
        ...
        ret.setMu16CellNumber(1);
        ret.setMu16ProtolLayerSelect(2563);  //515gai  579改成2051
